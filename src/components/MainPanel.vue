            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#pablo">
                  ...
                  <p class="d-lg-none d-md-block">حساب کاربری</p>
                </a>
              </li>
            </ul>
          </div>
        ...
        <footer class="footer">
          <div class="container-fluid">
            <nav class="float-left">
              <ul>
                <li>
                  <a href="https://www.creative-tim.com">تیم خلاق</a>
                </li>
                <li>
                  <a href="https://creative-tim.com/presentation">درباره ما</a>
                </li>
                <li>
                  <a href="http://blog.creative-tim.com">بلاگ</a>
                </li>
                <li>
                  <a href="https://www.creative-tim.com/license">اجازه نامه</a>
                </li>
              </ul>
            </nav>
